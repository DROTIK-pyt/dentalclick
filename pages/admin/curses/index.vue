    ...
    methods: {
        async checkAccess() {
            if(this.$store.getters['admins/getIsAuth']) {
                ...
                const {showCurses} = await result.json()
        ...
        async getAllData() {
            ...
            const result = await fetch(`${baseSettings.baseUrl}:${baseSettings.port}/admin/all-curse`)
            const responsed = await result.json()
        ...
        async toEditCurse(curse) {
            ...
            const result = await fetch(`${baseSettings.baseUrl}:${baseSettings.port}/admin/data-curse`, {
                method: "POST",
                headers: {
                    'Content-Type': 'application/json;charset=utf-8',
                },
        ...
        async saveEditCurse() {
            ...
            const result = await fetch(`${baseSettings.baseUrl}:${baseSettings.port}/admin/put-curses`, {
                method: "POST",
                headers: {
